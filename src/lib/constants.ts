...
export const CATEGORIES = [
  ...
  },
  {
    ...
    icon: 'zap',
    image: '/images/opt/products/frame-nd-yag-lezerkeszulek-1-480w.webp',
    featured: true,
    productCount: 2,
  ...
  },
  {
    ...
    slug: 'anti-aging',
    description: 'Vákuumos mikrotűs RF és AI-támogatott bőrfiatalító készülékek.',
    icon: 'sparkles',
  ...
  },
  {
    ...
    icon: 'cpu',
    image: '/images/opt/products/elitepod-system-1-480w.webp',
    featured: true,
    productCount: 1,
...
export const CATEGORY_CARD_IMAGE: Record<string, string> = {
  ...
  sminktetovalas: '/images/opt/products/mast-p60-premium-2in1-sminktetovalo-gep-allithato-lokethosszal-pot-akkumulatorral-2-828w.avif',
