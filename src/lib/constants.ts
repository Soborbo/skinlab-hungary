  ...
  columns: [
    {
      ...
      items: [
        { labelKey: 'categories.diodalezerek', href: '/diodalezerek', count: 12, descriptionKey: 'megaMenu.diodeDesc' },
        { labelKey: 'categories.nd-yag-lezerek', href: '/nd-yag-lezerek', count: 8, descriptionKey: 'megaMenu.ndyagDesc' },
        { labelKey: 'categories.pico-lezerek', href: '/pico-lezerek', count: 1, descriptionKey: 'megaMenu.picoDesc' },
      ],
    },
    {
      ...
      items: [
        ...
        { labelKey: 'categories.hiemt', href: '/hiemt', count: 4, descriptionKey: 'megaMenu.hiemtDesc', badgeKey: 'common.new' },
        { labelKey: 'categories.anti-aging', href: '/anti-aging', count: 3, descriptionKey: 'megaMenu.antiAgingDesc' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { labelKey: 'categories.szalonberendezes', href: '/szalonberendezes', count: 5, descriptionKey: 'megaMenu.furnitureDesc' },
        { labelKey: 'categories.kellekek', href: '/kellekek', count: 14, descriptionKey: 'megaMenu.accessoriesDesc' },
      ],
    },
  ],
  cta: {
