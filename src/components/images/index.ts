 ...
 *
 * All components include 480px width for optimal tablet/mobile coverage.
 *
 * Pattern Reference:
 ...
 * | ThirdImage      | THIRD       | 33vw   | 3-column grids (alias)            |
...
export { default as ThirdImage } from './ThirdImage.astro';
