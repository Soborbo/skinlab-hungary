...
export const SOCIAL = {
  facebook: { url: 'https://facebook.com/skinlabhungary', label: 'Facebook' },
  instagram: { url: 'https://www.instagram.com/skinlabhungary', label: 'Instagram' },
  tiktok: { url: 'https://www.tiktok.com/@skinlabhungary', label: 'TikTok' },
};
